...
namespace BullkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        //the BindProperty data annotation is used to bind the proparities you sent from the get method to the post
        [BindProperty]
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new()
            {
                ...
                == userId, includeProperaties: "Product"),
                OrderHeader = new()
            };
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == id, includeProperaties: "ApplicationUser");
